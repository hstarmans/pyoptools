...
def get_eigen_include_path():
    ...
    if env_path and (os.path.exists(os.path.join(env_path, "Eigen", "Dense")) or os.path.exists(env_path)):
        return env_path
    ...
    for candidate in [
        ...
        if os.path.exists(os.path.join(candidate, "Eigen", "Dense")) or os.path.exists(candidate):
            return candidate
